...
def custom_exception_handler(exc, context):
    ...
    if response is not None:
        response.data['custom_error'] = 'An error occurred'
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 5,  # You can change the number of books per page
...
EMAIL_PORT = 587  # For TLSs
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'shaikhzishan15107@gmail.com'
EMAIL_HOST_PASSWORD = 'Zishan@0987'